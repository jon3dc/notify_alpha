...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { account_id: @major.account_id, description: @major.description, name: @major.name } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { account_id: @major.account_id, description: @major.description, name: @major.name } }
